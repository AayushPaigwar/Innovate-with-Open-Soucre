...
const VersionHistory = () => (
  <div className="space-y-2">
    {[
      {
        number: 1,
        value: "Fork the Repository: Create your own copy of the repo.",
      },
      {
        number: 2,
        value:
          "Clone Your Fork: Download your forked repo to your local machine",
      },
      ...
      {
        number: 5,
        value: "Push to GitHub: Upload your branch to your GitHub repository.",
      },
      {
        number: 6,
        value:
          "Create a Pull Request: Submit your changes for review in the original repository.",
      },
    ].map((version) => (
      <div
        key={version.number}
